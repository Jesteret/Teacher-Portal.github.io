...
function cloak() {
  ...
  page.setType("blank");
  //Set the url
  page.setUrl("https://plexile-arcade.glitch.me");
  //Get iframe code
...
function alchemy() {
  ...
  //Set the url
  page.setUrl(
    "https://higuysdontblockthis.mathlearning.top/uv/service/hvtrs8%2F-lktvlgancjeoy%2Ccmm-"
  );
  //Get iframe code
  console.log(page.getCode());
  //Open page
...
function alchemy2() {
  ...
  //Set the url
  page.setUrl(
    "https://higuysdontblockthis.mathlearning.top/uv/service/hvtrs8%2F-lktvlgancjeoy0.aoo%2F"
  );
  //Get iframe code
  console.log(page.getCode());
  //Open page
